export const mainDescription =
  "Blog juniora, frontendowca skupiony na tym by pokazać ciekawe feature'y , efekty cssa, których mogliście nieznać."
...
export const menu = [
  ...
  {content: "O mnie", path: "/o-mnie"}
]
export const sideMenu = [
  {content: "Strona Główna", path: "/"},
  {content: "Artykuły", path: "/articles/1"},
  {content: "Newsletter", path: "/newsletter"},
  {content: "O mnie", path: "/o-mnie"}
]